...
struct BMPInfoHeader {
	...
	uint32_t compression{ 0 };               // 0(24 bits) or 3(32 bits) - uncompressed. THIS PROGRAM CONSIDERS ONLY UNCOMPRESSED BMP images
...
For simplicity, we will consider only the case when the image height
is a positive number and the origin is always in the bottom left corner.
*/
